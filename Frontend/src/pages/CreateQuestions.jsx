...
import { questionEndpoints } from "../services/APIs/index";
import { setQuiz, setEdit } from "../slices/QuizSlice";
import CreateQuestionModel from "../components/core/createQuiz/CreateQuestionModel";
  ...
  const deleteQuestionHandler = async (question) => {
    try {
      const response = await apiConnector(
        "DELETE",
        `${questionEndpoints.DELETE_QUESTION}/${question._id}`,
        null,
        {
